...
export class ManageOrderComponent implements OnInit {
  ...
  getProductsByCategory(value: any) {
    this.productService.getProductsByCategory(value.categoryId).subscribe(
      (response: any) => {
  ...
  getProductDetails(value: any) {
    this.productService.getById(value.pId).subscribe(
      (response: any) => {
  ...
  add() {
    ...
    var productName = this.dataSource.find(
      (e: { pId: number }) => e.pId == formData.product.pId
    );
    if (productName === undefined) {
      this.totalAmount = this.totalAmount + formData.total;
      this.dataSource.push({
        pId: formData.product.pId,
        pName: formData.product.pName,
